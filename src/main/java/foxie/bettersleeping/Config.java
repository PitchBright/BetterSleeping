...
public class Config {
   ...
   public static boolean wakeUpWithFirstPerson = false; // wake up when the first person's energy fills up
   public static boolean capEnergyBar          = false; // caps energy bar to the maximum value
   ...
   public Config(String filename) {
      ...
      wakeUpWithFirstPerson = cfg.getBoolean("wakeUpWithFirstPerson", "config", wakeUpWithFirstPerson, "wake up when the first person's energy fills up");

      capEnergyBar = cfg.getBoolean("capEnergyBar", "config", capEnergyBar, "cap energy bar on the maximum allowed value");
